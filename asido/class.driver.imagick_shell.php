...
* @see Asido_IMagick
*/
require_once ASIDO_DIR . "packages/core/includes/utils/image/class.imagick.php";
...
*/
require_once ASIDO_DIR . "packages/core/includes/utils/image/class.driver.shell.php";
